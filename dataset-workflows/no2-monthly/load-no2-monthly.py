...
prefix = "OMNO2d_HRM/"
tmp_collection_file = "no2-collection-nd.json"
tmp_items_file = "no2-items-nd.json"
...
if __name__ == "__main__":
    ...
    print(f"{len(results)} Items written to {tmp_items_file}")
    ...
    if not dry_run:
      ...
      pypgstac.load(
        ...
        file=tmp_items_file,
        dsn=dsn,
        method="insert_ignore", # use insert_ignore to avoid overwritting existing items or upsert to replace items with the same id
      )
