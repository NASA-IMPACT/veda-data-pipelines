...
# ./list-s3-files.sh s3://covid-eo-data viirs/source_data/COVID19_Dashboard_BMHD/ .tif s3://covid-eo-data/BMHD_30M_MONTHLY
#
...
# ./list-s3-files.sh s3://covid-eo-data viirs/source_data/VNP46A2_V011/ "-v .hdr" s3://covid-eo-data/BM_500M_DAILY
S3_SRC_BUCKET=$1
S3_SRC_DIR=$2
LINK_FINDER=$3
S3_DEST=$4
