...
class Config(BaseSettings):
    ...
    EARTHDATA_USERNAME: str = Field(
        Description="Earthdata username", env="EARTHDATA_USERNAME", default="XXXX"
    )
    EARTHDATA_PASSWORD: str = Field(
        Description="Earthdata password", env="EARTHDATA_PASSWORD", default="XXXX"
    )
    ...
    OIDC_PROVIDER_ARN: Optional[str] = Field(
        Description="ARN of OIDC provider", env="OIDC_PROVIDER_ARN", default=None
    )
